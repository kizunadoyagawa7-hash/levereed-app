...
/**
 * AI自動集客システム 専用LP
 * カード2「詳細を見て機能を解放する」から遷移。戻るは /business。
 */
export default function AcquisitionSupportLP() {
  return (
    <div className="min-h-screen bg-[#0f142a] text-white">
      ...
      <main className="relative mx-auto max-w-2xl px-4 py-10">
        <nav className="mb-8 text-sm text-white/60" aria-label="パンくず">
          ...
          <span className="text-white/90">AI自動集客システム</span>
        </nav>
        <h1 className="text-2xl font-bold text-white sm:text-3xl">AI自動集客システム</h1>
        <p className="mt-4 text-white/90 leading-relaxed">
          あなたが寝ている間に、質の高い見込み客リストが自動で積み上がります。ターゲット選定・LP/SNS構成・ツール連携まで、8年の知見を反映したプログラムで集客を完全自動化します。
        </p>
        <div className="mt-10 rounded-2xl border-2 p-6 text-center" style={{ borderColor: `${ACTION_ORANGE}99`, backgroundColor: `${ACTION_ORANGE}15` }}>
          <p className="text-sm font-medium text-white/90">パートナー会員で全Phase解放</p>
          <Link
            href="/business"
